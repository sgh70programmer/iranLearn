        ...
        <table className="table">
          ...
          <tbody>
            {comments.map((comment, index) => (
              <tr>
                <td className={comment.answer ? "answer-comment" : "no-answer-comment"}>{index + 1}</td>
                <td>{comment.creator.name}</td>
                <td>{comment.course}</td>
                <td>
                  {
                    Array(5 - comment.score).fill(0).map(item => (
                      <img src="/images/svgs/star.svg" alt="score" loading="lazy"/>
                    ))
                  }
                  {
                    Array(comment.score).fill(0).map(item => (
                      <img src="/images/svgs/star_fill.svg" alt="score" loading="lazy"/>
                    ))
                  }
                </td>
                <td>
