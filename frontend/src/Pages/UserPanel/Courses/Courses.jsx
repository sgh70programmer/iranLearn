        ...
        <div className="courses-header__panel">
          ...
          <ul className="courses-header__list">
            <li className="courses-header__item"
              ...
              <a
                className={`courses-header__link__panel ${showCourseState === "all"
            ...
            <li className="courses-header__item" onClick={(event) => {
              event.preventDefault();
              setShowCourseState("free");
              filterCourses("free");
            }}>
              <a className={`courses-header__link__panel ${showCourseState === "free"
                ? "courses-header__link-active"
                : null
                }`} href="#">
                دوره های رایگان
            ...
            <li className="courses-header__item" onClick={(event) => {
              ...
              <a className={`courses-header__link__panel ${showCourseState === "money"
                ? "courses-header__link-active"
                : null
                }`} href="#">
                دوره های پولی
